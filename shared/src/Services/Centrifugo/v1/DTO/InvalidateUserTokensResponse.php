...
/**
 * Generated from protobuf message <code>api.centrifugo.v1.dto.InvalidateUserTokensResponse</code>
 */
class InvalidateUserTokensResponse extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.api.centrifugo.v1.dto.InvalidateUserTokensResult result = 2;</code>
     */
     ...
     *     @type \Spiral\Shared\Services\Centrifugo\v1\DTO\InvalidateUserTokensResult $result
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.api.centrifugo.v1.dto.InvalidateUserTokensResult result = 2;</code>
     * @return \Spiral\Shared\Services\Centrifugo\v1\DTO\InvalidateUserTokensResult
     */
    ...
    /**
     * Generated from protobuf field <code>.api.centrifugo.v1.dto.InvalidateUserTokensResult result = 2;</code>
     * @param \Spiral\Shared\Services\Centrifugo\v1\DTO\InvalidateUserTokensResult $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Spiral\Shared\Services\Centrifugo\v1\DTO\InvalidateUserTokensResult::class);
        $this->result = $var;
